(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, {
    otherChunks: ["static/chunks/10ho3qy1i1e_e.js", "static/chunks/05pxe.pkwelhe.js", "static/chunks/07lhk_q6pmm3r.js"],
    ...
    var o, l = ((o = l || {})[o.Runtime = 0] = "Runtime", o[o.Parent = 1] = "Parent", o[o.Update = 2] = "Update", o);
    let i = new WeakMap;
    ...
    u.s = function(e, t) {
        ...
        let u = (r = o, n = l, (s = i.get(r)) || (i.set(r, s = []), r.exports = r.namespaceObject = new Proxy(n, {
            get(e, t) {
    ...
    u.a = function(e, t) {
        ...
        Object.defineProperty(r, "exports", a), Object.defineProperty(r, "namespaceObject", a), e(function(e) {
            ...
            return t.map(e => e[j](u)), s.queueCount ? l : r()
        }, function(e) {
            e ? i(u[C] = e) : l(u[U]), P(n)
    ...
    v.prototype = URL.prototype, u.U = v, u.z = function(e) {
    ...
    async function T(e, t, r) {
        ...
        if (s.length > 0) {
            ...
            for (let o of (n = M(e, t, q(r.path)), i)) E.has(o) || E.set(o, n)
        }
    ...
    function M(t, r, n) {
        ...
        if (void 0 === i) {
            ...
            i = o.then(e).catch(e => {
                ...
                let i = Error(`Failed to load chunk ${n} ${o}${e?`: ${e}`:""}`, e ? {
                    cause: e
                } : void 0);
    ...
    S.L = function(e) {
        ...
        let u = new URL(q(t), location.origin),
            a = JSON.stringify(s);
        return i ? u.searchParams.set("params", a) : u.hash = "#params=" + encodeURIComponent(a), new e(u, l ? { ...l,
            type: void 0
        } : void 0)
    };
    let N = /\.js(?:\?[^#]*)?(?:#.*)?$/,
    ...
    function F(t) {
        ...
        return 2 === t.length ? r = t[1] : (r = void 0, ! function(e, t) {
            ...
            for (; r < e.length;) {
                ...
                for (let n = r; n < o; n++) {
                    let r = e[n];
                    t.has(r) || (s || (i === l && Object.defineProperty(l, "name", {
    ...
    e = {
        async registerChunk(e, r) {
            ...
            if (D("string" == typeof e ? q(e) : e.src).resolve(), null != r) {
                ...
                if (await Promise.all(r.otherChunks.map(e => T(l.Runtime, n, e))), r.runtimeModuleIds.length > 0)
