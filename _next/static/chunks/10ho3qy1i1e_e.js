(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 35451, (e, t, r) => {
    ...
    var j = O.prototype = new S;
    j.constructor = O, m(j, x.prototype), j.isPureReactComponent = !0;
    var E = Array.isArray;
    ...
    function P(e, t, r) {
        ...
        return ! function e(t, r, n, u, s) {
            ...
            if (d) return s = s(t), d = "" === u ? "." + A(t, 0) : u, E(s) ? (n = "", null != d && (n = d.replace(k, "$&/") + "/"), e(s, r, n, "", function(e) {
                return e
            })) : null != s && (H(s) && (a = s, c = n + (null == s.key || t && t.key === s.key ? "" : ("" + s.key).replace(k, "$&/") + "/") + d, s = C(a.type, c, a.props)), r.push(s)), 1;
            d = 0;
            var p = "" === u ? "." : u + ":";
            if (E(t))
                for (var g = 0; g < t.length; g++) f = p + A(u = t[g], g), d += e(u, r, n, f, s);
            else if ("function" == typeof(g = null === (l = t) || "object" != typeof l ? null : "function" == typeof(l = b && l[b] || l["@@iterator"]) ? l : null))
                for (t = g.call(t), g = 0; !(u = t.next()).done;) f = p + A(u = u.value, g++), d += e(u, r, n, f, s);
            else if ("object" === f) {
    ...
    }, r.Component = x, r.Fragment = u, r.Profiler = a, r.PureComponent = O, r.StrictMode = s, r.Suspense = d, r.ViewTransition = h, r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = w, r.__COMPILER_RUNTIME = {
        __proto__: null,
        c: function(e) {
    ...
    }, r.isValidElement = H, r.lazy = function(e) {
        return {
            $$typeof: y,
            _payload: {
                _status: -1,
    ...
    }, r.startTransition = I, r.unstable_useCacheRefresh = function() {
                    ...
                    children: [(0, n.jsx)("div", {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsx)(i.WarningIcon, {}), (0, n.jsx)("h1", {
                                ...
                                children: r ? "A server error occurred. Reload to try again." : "Reload to try again, or go back."
                            }), (0, n.jsxs)("div", {
